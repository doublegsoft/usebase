...
public class ValueParser extends UsebaseParser {
  ...
  private final io.doublegsoft.exprbase.parser.ValueParser exprbaseValueParser;

  public ValueParser(ModelDefinition dataModel) {
    super(dataModel);
    exprbaseValueParser = new io.doublegsoft.exprbase.parser.ValueParser(dataModel);
  }
  ...
  public void assemble(io.doublegsoft.usebase.UsebaseParser.Anybase_valueContext ctx,
    ...
    exprbaseValueParser.assemble(getOriginalText(ctx), value, usecase);
  }
